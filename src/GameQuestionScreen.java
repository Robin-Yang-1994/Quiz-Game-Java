...
public class GameQuestionScreen extends JFrame

{
	...
	private JPanel gamQuestPanel =  new JPanel(); 
	...
	public GameQuestionScreen(int questionNumber)
{	
	...
	gamQuestPanel.setLayout(null);
	
	gamQuestPanel.setBackground(Color.gray);
	add(gamQuestPanel).setVisible(true);
	...
	gamQuestPanel.add(moneyImage);
	
	moneyPrize.setText("£"+ money[prize]); // Prize is getting increased by 1, then 2, then 3 if the user get answers right
	moneyPrize.setFont(new Font("Dialog", 1,14));
	moneyPrize.setBounds(50,275,150,30);
	gamQuestPanel.add(moneyPrize);
	
	questions.setText(main.getGameArray().get(questionNumber).question);
	questions.setFont(new Font("Dialog", 1,14));
	questions.setBounds(25,350,500,75);// X,Y,Height,Width
	gamQuestPanel.add(questions);
    ...
    ans1.setText(main.getGameArray().get(questionNumber).getPossibleAns1()); // Answer 1, All answers will be in different orders
    ...
    gamQuestPanel.add(ans1);
    
    
    ans2.setText(main.getGameArray().get(questionNumber).getPossibleAns2()); // Answer 2
    ...
    gamQuestPanel.add(ans2);
    
    ans3.setText(main.getGameArray().get(questionNumber).getPossibleAns3()); // Answer 3
    ...
    gamQuestPanel.add(ans3);
    
    ans4.setText(main.getGameArray().get(questionNumber).getPossibleAns4()); // Answer 4
    ...
    private void fiftyFifty()
     {
    	 if (ans1.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[0]) || ans1.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans1.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans2.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[0]) || ans2.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans2.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans3.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[0]) || ans3.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans3.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans4.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[0]) || ans4.getText().equals(main.getGameArray().get(questionNumber).fiftyFifty[1]))
    	 {
     ...
     private void giveClue()
     {
    	 ...
    	 clueText.setText(main.getGameArray().get(questionNumber).giveClue);
    ...
    public static void sound (URL sound)
     ...
     {
    	 if (Questions.equals(main.getGameArray().get(questionNumber).correctAns)) // Checks if correct answer equals the clicked answer
    	 {   
    		 crtAnsScr.setVisible(true);
    		 crtAnsScr.setModal(true);
    		 main.getGameArray().remove(questionNumber);
    		 i = i - 1;
    		 prize =  prize + 1;
    		 moneyPrize.setText("£"+ money[prize]);
    		 questionNumber = r.nextInt(i);
    		 questions.setText(main.getGameArray().get(questionNumber).question);
    		 ans1.setText(main.getGameArray().get(questionNumber).getPossibleAns1());
    		 ans1.setVisible(true);
    		 ans2.setText(main.getGameArray().get(questionNumber).getPossibleAns2());
    		 ans2.setVisible(true);
    		 ans3.setText(main.getGameArray().get(questionNumber).getPossibleAns3());
    		 ans3.setVisible(true);
    		 ans4.setText(main.getGameArray().get(questionNumber).getPossibleAns4());
