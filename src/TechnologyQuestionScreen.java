...
public class TechnologyQuestionScreen extends JFrame

{
	...
	private JPanel techQuestPanel =  new JPanel(); 
	...
	public TechnologyQuestionScreen(int questionNumber)
{
	...
	techQuestPanel.setLayout(null);
	
	techQuestPanel.setBackground(Color.gray);
	add(techQuestPanel).setVisible(true);
	...
	techQuestPanel.add(moneyImage);
	
	moneyPrize.setText("£"+ money[prize]);
	moneyPrize.setFont(new Font("Dialog", 1,14));
	moneyPrize.setBounds(50,275,150,30);
	techQuestPanel.add(moneyPrize);
	
	questions.setText(main.getTechArray().get(questionNumber).question);
	questions.setFont(new Font("Dialog", 1,14));
	questions.setBounds(25,350,500,75);// X,Y,Height,Width
	techQuestPanel.add(questions);
    ...
    techQuestPanel.add(audienceBtn);
    ...
    techQuestPanel.add(halfHalfBtn);

    clueBtn.setIcon(new ImageIcon(TechnologyQuestionScreen.class.getResource("Image/QuestionClue.jpg"))); // Clue Button
    ...
    ans1.setText(main.getTechArray().get(questionNumber).getPossibleAns1()); // Answer 1, All answers will be in different orders
    ...
    techQuestPanel.add(ans1);
    
    
    ans2.setText(main.getTechArray().get(questionNumber).getPossibleAns2()); // Answer 2
    ...
    techQuestPanel.add(ans2);
    
    ans3.setText(main.getTechArray().get(questionNumber).getPossibleAns3()); // Answer 3
    ...
    techQuestPanel.add(ans3);
    
    ans4.setText(main.getTechArray().get(questionNumber).getPossibleAns4()); // Answer 4
    ...
    public void jbuttonClose()
    {
     ...
     {
    	 if (ans1.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[0]) || ans1.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans1.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans2.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[0]) || ans2.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans2.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans3.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[0]) || ans3.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[1]))
    	 {
    		 ans3.setVisible(false);
    		 halfHalfBtn.setVisible(false);
    	 }
    	 
    	 if (ans4.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[0]) || ans4.getText().equals(main.getTechArray().get(questionNumber).fiftyFifty[1]))
    	 {
     ...
     private void giveClue()
     {
    	 ...
    	 clueText.setText(main.getTechArray().get(questionNumber).giveClue);
     ...
     private void checkAnswer(String Questions) {
    	 if (Questions.equals(main.getTechArray().get(questionNumber).correctAns)) // Checks if correct answer equals the clicked answer
    	 {   
    		 crtAnsScr.setVisible(true);
    		 crtAnsScr.setModal(true);
    		 main.getTechArray().remove(questionNumber);
    		 i = i -1;
    		 prize =  prize + 1;
    		 moneyPrize.setText("£"+ money[prize]);
    		 questionNumber = r.nextInt(i);
    		 questions.setText(main.getTechArray().get(questionNumber).question);
    		 ans1.setText(main.getTechArray().get(questionNumber).getPossibleAns1());
    		 ans1.setVisible(true);
    		 ans2.setText(main.getTechArray().get(questionNumber).getPossibleAns2());
    		 ans2.setVisible(true);
    		 ans3.setText(main.getTechArray().get(questionNumber).getPossibleAns3());
    		 ans3.setVisible(true);
    		 ans4.setText(main.getTechArray().get(questionNumber).getPossibleAns4());
